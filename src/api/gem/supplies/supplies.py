...
@router.get('/get_all_supplies/',response_model=ListSupplies)
...
@router.post('/create_supplies/',response_model=Response_SM)
def create_supplies(
    sps: SuppliesBase,
    db: Session = Depends(get_db),
    current_user: UserCreate = Depends(get_admin_user)
...
@router.put('/update_supplies/',response_model=Response_SM)
def update_supplies(
    sps: Supplies,
    db: Session = Depends(get_db),
    current_user: UserCreate = Depends(get_admin_user)
