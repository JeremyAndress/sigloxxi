...
from schemas.reservation import ReservationBase, ReservationList
...
def reservation_create(rsvt: ReservationBase, db:Session = Depends(get_db)):
    response = create_rsvt(db, rsvt)
    return response
